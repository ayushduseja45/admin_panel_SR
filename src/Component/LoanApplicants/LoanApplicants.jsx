...
//           {status === "pending" ? (
//             <Link
//               to={`/loan-applications/${applicant.id}`}
//               className="bg-blue-500 text-white px-4 py-2 rounded"
//             >
//               View Details
//             </Link>
...
//         <button
//           onClick={() => setActiveTab("pending")}
//           className={`px-4 py-2 rounded ${activeTab === "pending" ? "bg-yellow-500 text-white" : "bg-gray-200"
//             }`}
//         >
//           Pending
//         </button>
//         <button
//           onClick={() => setActiveTab("approved")}
//           className={`px-4 py-2 rounded ${activeTab === "approved" ? "bg-green-500 text-white" : "bg-gray-200"
//             }`}
//         >
//           Approved
//         </button>
//         <button
//           onClick={() => setActiveTab("declined")}
//           className={`px-4 py-2 rounded ${activeTab === "declined" ? "bg-red-500 text-white" : "bg-gray-200"
//             }`}
//         >
//           Declined
//         </button>
...
//       status: "pending",
//       documents: {
//         "Identification Proof": { aadhar: "aadhar-doc-url" },
//         "Income Proof": { payslip: "payslip-doc-url" },
//       },
//     },
//     {
//       id: 2,
