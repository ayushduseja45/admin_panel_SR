...
const navigation = [
  ...
  { name: 'Loan Applications', href: '#', icon: FolderIcon, current: false },
...
function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar for desktop */}
      <div className={`fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-gray-800 transform transition-transform duration-200 ease-in-out lg:translate-x-0 ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-3 py-4 border-t border-gray-200 dark:border-gray-700">
            <h3 className="px-3 text-sm font-medium text-gray-500 dark:text-gray-400">Your teams</h3>
